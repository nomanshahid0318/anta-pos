...
const HO_I18N = {
  en: {
    ...
    overview:'Overview', stock:'Stock Management', finance:'Finance', hr_sec:'HR', admin:'Admin', products_sec:'Products',
  ...
  ar: {
    ...
    overview:'نظرة عامة', stock:'إدارة المخزون', finance:'المالية', hr_sec:'الموارد البشرية', admin:'الإدارة', products_sec:'المنتجات',
  ...
  try {
    ...
    document.querySelectorAll('.nav-sec').forEach(el => {
      ...
      const map = {
        ...
        'finance':'finance', 'hr':'hr_sec', 'reports':'reports_sec', 'admin':'admin'
      };
